...
Format citations and validate source attribution using functions in `agents/generator_agent.py`. Handles both internal knowledge base (ChromaDB) sources and external web search sources with appropriate citation formats.
